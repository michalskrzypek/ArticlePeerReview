...
%>
	<div class="container">
		...
		<form action="createArticle.jsp" method="post">
			<input class="button_2" type="submit" name="query" value="Create an article">
		</form>


		<form action="ArticlesViewerServlet" method="post">
			<input class="button_2" type="submit" name="query" value="My articles">
		</form>

		<form action="DecisionsViewerServlet" method="post">
			<input class="button_2" type="submit" name="query" value="My articles with decision">
		</form>
		<br><br>
		</section>
